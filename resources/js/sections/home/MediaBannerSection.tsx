    ...
    <section className="relative overflow-hidden bg-surface py-16">
      <Container>
        <div className="relative overflow-hidden rounded-card border border-border">
          ...
          />
          <div className="absolute inset-x-0 bottom-0 z-20 flex flex-col items-start justify-between gap-4 bg-gradient-to-t from-background via-background/80 to-transparent p-6 sm:flex-row sm:items-end sm:p-10">
            <div>
